...
CREATE TABLE SpotifyClone.seguindo_artistas(
	usuario_id INT NOT NULL,
    artista INT NOT NULL,
    PRIMARY KEY (usuario_id, artista),
    FOREIGN KEY (usuario_id) REFERENCES SpotifyClone.usuarios(usuario_id),
    FOREIGN KEY (artista) REFERENCES SpotifyClone.artistas(artista_id)
) ENGINE = InnoDB;
...
INSERT INTO SpotifyClone.usuarios (usuario_id, usuario, idade, data_assinatura, plano)
VALUES
...
INSERT INTO SpotifyClone.seguindo_artistas (usuario_id, artista)
VALUES
	(1,	1), (1,	4), (1,	3), (2,	1), (2,	3), (3,	1), (3,	2), (4,	4), (5,	5), (5,	6), (6,	1), (6,	3), (6,	6), (7,	2), (7,	5), (8,	1),
	(8,	5), (9,	3), (9,	4), (9,	6), (10, 2), (10, 6)
;
